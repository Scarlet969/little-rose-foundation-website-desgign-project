<?php
/*
Template Name: Vision Art - All In One
*/
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        /* NÂNG CẤP CARD TRÔNG HIỆN ĐẠI HƠN */
        .card-about {
        ...
        /* Hiệu ứng lật khi di chuột vào */
        .lrf-flip-card:hover .flip-inner {
        ...
        .flip-front, .flip-back {
            ...
            width: 100%;
            height: 100%;
            -webkit-backface-visibility: hidden; /* Giấu mặt sau khi lật */
        ...
        /* Mặt sau: Có ảnh nền + Nút ở dưới */
        .flip-back {
            background-size: cover;
            background-position: center;
            color: white;
            transform: rotateY(180deg); /* Mặt sau mặc định quay 180 độ */
            overflow: hidden;
        }
        ...
        .flip-back .overlay {
            ...
            background: rgba(0, 0, 0, 0.4); /* Lớp phủ đen mờ để nổi bật nút */
            z-index: 1;
        }
        ...
        .back-content {
            ...
            display: flex;
            flex-direction: column;
            justify-content: flex-end; /* Đẩy nội dung (nút) xuống đáy */
        }
...
<body <?php body_class(); ?>>
    ...
    <div class="container my-5 py-4">
        ...
        <!-- Ô 1: TẦM NHÌN -->
        <div class="col-md-4">
            <div class="lrf-flip-card">
                <div class="flip-inner">
                    <!-- MẶT TRƯỚC -->
                    <div class="flip-front shadow-sm">
                        <i class="fas fa-eye fa-3x text-success mb-3"></i>
                        <h4 class="fw-bold" data-vi="Tầm nhìn" data-en="Vision">Tầm nhìn</h4>
                        <p class="text-secondary mt-3" data-vi="Một Việt Nam nơi không trẻ em nghèo nào bị bỏ lại phía sau vì thiếu kinh phí chữa bệnh hay cơ hội học tập." data-en="A Vietnam where no underprivileged child is left behind due to a lack of medical funds or educational opportunities.">
                            Một Việt Nam nơi không trẻ em nghèo nào bị bỏ lại phía sau vì thiếu kinh phí chữa bệnh hay cơ hội học tập.
                        </p>
                        <div class="hint-text mt-4 small text-muted italic">
                            <i class="fas fa-mouse-pointer me-1"></i> <span data-vi="Rê chuột để xem thành tựu" data-en="Hover to see achievements">Rê chuột để xem thành tựu</span>
                        </div>
                    </div>
                    <!-- MẶT SAU -->
                    <div class="flip-back" style="background-image: url('https://petal-three-lrf.infinityfreeapp.com/wp-content/uploads/2026/01/treemngheo.jpg');">
                        <div class="overlay"></div>
                        <div class="back-content p-4">
                            <a href="<?php echo home_url('/about'); ?>" class="btn btn-success rounded-pill px-4 fw-bold mt-auto" data-vi="Xem những gì chúng tôi đã làm" data-en="See what we've done">
            ...
            <div class="lrf-flip-card">
                <div class="flip-inner">
                    ...
                    <div class="flip-front shadow-sm">
                        ...
                        <p class="text-secondary mt-3" data-vi="Huy động nguồn lực xã hội để tài trợ phẫu thuật, trao học bổng và lắp đặt hệ thống nước sạch cho cộng đồng khó khăn." data-en="Mobilizing social resources to fund surgeries, award scholarships, and install clean water systems.">
                            Huy động nguồn lực xã hội để tài trợ phẫu thuật, trao học bổng và lắp đặt hệ thống nước sạch cho cộng đồng khó khăn.
                        </p>
                    </div>
                    <!-- MẶT SAU -->
                    <div class="flip-back" style="background-image: url('https://petal-three-lrf.infinityfreeapp.com/wp-content/uploads/2026/01/istockphoto-1586911323-612x612-1.jpg');">
                        <div class="overlay"></div>
                        <div class="back-content p-4">
                            <a href="<?php echo home_url('/project/'); ?>" class="btn btn-danger rounded-pill px-4 fw-bold mt-auto" data-vi="Xem dự án đang triển khai" data-en="View ongoing projects">
                                Xem dự án đang triển khai
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="lrf-flip-card">
                <div class="flip-inner">
                    ...
                    <div class="flip-front bg-success text-white">
                        ...
                        <ul class="list-unstyled mt-3 fw-bold text-start w-100 px-3" style="font-size: 0.9rem; line-height: 1.8;">
                            <li class="mb-2"><i class="fas fa-check-circle me-2"></i> Yêu thương & Chính trực</li>
                            <li class="mb-2"><i class="fas fa-check-circle me-2"></i> Tôn trọng & Tận tâm</li>
                            <li><i class="fas fa-check-circle me-2"></i> Minh bạch tài chính</li>
                        </ul>
                    </div>
                    <!-- MẶT SAU -->
                    <div class="flip-back" style="background-image: url('https://petal-three-lrf.infinityfreeapp.com/wp-content/uploads/2026/01/about-us-lrf-1-2048x1365-1.jpg');">
                        <div class="overlay"></div>
                        <div class="back-content p-4">
                            <a href="<?php echo home_url('/bao-cao/'); ?>" class="btn btn-light text-success rounded-pill px-4 fw-bold mt-auto" data-vi="Xem báo cáo tài chính" data-en="View financial reports">
